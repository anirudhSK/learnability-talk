...
\noindent \only<1>{\includegraphics[width=3.4 in]{multilink-background.pdf}}\only<2>{\includegraphics[width=3.4 in]{multilink-omniscient.pdf}}\only<3>{\includegraphics[width=3.4 in]{multilink-twolink.pdf}}\only<4>{\includegraphics[width=3.4 in]{multilink-onelink.pdf}}\only<5>{\includegraphics[width=3.4 in]{multilink-rest.pdf}}
