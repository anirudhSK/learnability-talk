...
\item<1-> We found:
\begin{itemize}
\item<2-> \textcolor{green}{Possible to design for wide link speed range}
\item<3-> \textcolor{red}{Tension between low and high degrees of multiplexing}
\item<4-> \textcolor{green}{Simplifying topology only mildly hurts performance}
