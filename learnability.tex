...
\item<4-> \textcolor{red}{TCP compatibility is a double-edged sword}
\item<5-> Ongoing work in using findings to:
\begin{itemize}
\item<6-> improve Google's datacenter transport
\item<7-> user-space implementation of RemyCC
\end{itemize}
\item<8-> http://web.mit.edu/remy/learnability
\end{itemize}
\end{frame}
